...
const fetchCart = async () => {
    ...
    console.log("Auth Token in ItemCard:", authToken.toString());

    const response = await fetch(`${BACKEND_URL}/api/cart`,{
        headers: {
                "Content-Type": "application/json",
                "Authorization": `Bearer ${authToken.toString()}` // Header added here
                // ensure it is included here or handled by a global interceptor/cookie.
            },
    });
...
export default function CartPage() {
    ...
    // Handlers
    // TODO: Since specific API endpoints for update/delete were not provided in the prompt,
    // these are placeholders. You will need to implement the API calls here.
